...
/**
 * sitemap.xml — 공식 페이지만(랜딩 · 법적 고지 인덱스+7 · 계정 삭제 안내 · 만남 안전 가이드(H2)). E6.
...
const OFFICIAL_PATHS: readonly string[] = ["/", "/legal", ...LEGAL_ROUTE_SLUGS.map((s) => `/legal/${s}`), "/legal/business", "/account/delete", "/safety-guide"];
