...
### 3.4 끊김 처리 — 죄책감 카피 금지
브랜드 #31 원문(고정): 헤드라인 "오늘 카드 1장 준비돼 있어요" / 본문 "스트릭은 다시 1일부터. 지난 기록은 사라지지 않아요." / 버튼 "카드 보기". 대안 4개(A/B 후보, 전부 §10 lint 통과):

| # | 헤드라인 | 본문 | 검사 |
|---|---|---|---|
| 1 | 오늘 카드 1장 준비돼 있어요 | 스트릭은 다시 1일부터. 지난 기록은 사라지지 않아요. | 원문 |
| 2 | 다시 1일째예요 | 최고 기록 {best}일은 그대로 남아 있어요. | best는 실제 값 |
| 3 | 오늘 추천 {n}명이 와 있어요 | 오늘 완주하면 다시 1일이 시작돼요. | n 실제 값 |
| 4 | 새로 시작해요 | 스트릭은 매일 07:00에 새 추천과 함께 이어져요. | 시각 사실 |
| 5 | 잠깐 쉬었네요 | 카드 1장·추천 {n}명이 오늘 몫이에요. 서두를 건 없어요. | "서두르세요" 아님(부정문 허용 여부 lint 확인) |

금지: "아쉽게도", "놓쳤어요", "사라졌어요", "지켜주세요", 우는 이모지, 끊김 푸시, 끊김 직전 "오늘 안 하면" 알림. 스트릭 유지 목적의 푸시는 존재하지 않는다 — 슬롯 A/B 카피는 스트릭을 언급하지 않는다(§6).
