...
| tone-lab | 말투 5종 변환 | 룰 파이프라인 | ✅ | — | 구현 중 (2차) |
| roast-edit | 독설/칭찬 평가서 | 텍스트 메트릭 | ✅ | — | 구현 중 (2차) |
| dark-history | 흑역사 시대 판독 | 시대 렉시콘 | ✅ | — | 구현 중 (2차) |

## 다음 액션
- 2차 3앱 BUILTINS 등록(완료) → 6앱 상호 크로스링크 → 빌드 경고 0 확인 → 커밋·푸시 → PR ready → 머지(소유자 전권 위임됨).
