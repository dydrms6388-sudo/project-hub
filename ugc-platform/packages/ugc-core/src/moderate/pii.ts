...
// 실명+소속(휴리스틱): 명확한 소속 토큰 + 2~4자 한글 이름 + 직함/호칭(필수).
// 직함을 필수로 두어 정밀도를 높인다(짧고 흔한 한 글자 토큰 '과/부/국/처' 등은
// '국물·근처' 같은 일반어에 오탐하므로 제거).
const AFFILIATION_HINT =
  /(?:주식회사|㈜|회사|대학교|고등학교|중학교|초등학교|병원|의원|경찰서|소방서|법원|검찰청|세무서|구청|시청|군청|도청|주민센터|연구소|재단|협회)\s*[가-힣]{2,4}\s*(?:님|씨|대표|사장|이사|부장|과장|차장|대리|팀장|교수|박사|선생|기자|의원|판사|검사|변호사)/g;
